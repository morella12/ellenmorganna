...
export const metadata: Metadata = {
  title: "Ellen Morganna | Full-stack Developer",
  description:
    "Portfólio de desenvolvedora full-stack sênior para iGaming e tech, focado em resultados e clientes internacionais.",
};
...
export default function MarketingLayout({
  ...
  return (
    <html lang="pt-BR">
      <body className="bg-creme-50 text-slate-900 antialiased">
        <Header />
        <main>{children}</main>
        <Footer />
      </body>
